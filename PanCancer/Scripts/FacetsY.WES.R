...
WES.samples = read.csv('~/Master/Data/WES/WES_cBio_ID.match.txt', sep = '\t')
WES.samples = WES.samples[which(WES.samples$Sex == 'male'), ]
WES.samples = as.character(WES.samples$Facet_Countfile)
...
xx = lapply(unique(WES.samples), function(x) WES_Y_loss(files = x))
...
## Write Output
##----------------+
write.table(x = CopyNumberStates, file = '~/Master/Data/WES/WES_CopyNumberStates.txt', row.names = F, sep = '\t', quote = F)
write.table(x = Cnlr_Y, file = '~/Master/Data/WES/WES_Cnlr_Y.txt', row.names = F, sep = '\t', quote = F)
write.table(x = Cnlr_X, file = '~/Master/Data/WES/WES_Cnlr_X.txt', row.names = F, sep = '\t', quote = T)
write.table(x = WES_IGV_out, file = '~/Master/Data/WES/WES_IGV_out.seg', row.names = F, sep = '\t', quote = F)
write.table(x = Arm_changes, file = '~/Master/Data/WES/WES_arm_change_out.txt', row.names = F, sep = '\t', quote = F)
